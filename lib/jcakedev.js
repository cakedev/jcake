...
(function() {
  ...
  jcakedev.plugins.table = {
    ...
    create: function($elements, params) {
      ...
      return $elements.each(function() {
        var table;
        table = new Table($(this), fields, fieldNames, data, maxRecords, selectable, editable, erasable);
  ...
  Table = (function() {
    ...
    function Table(el, fields, fieldNames, data, maxRecords, selectable, editable, erasable) {
