(function() {
  var Combo, Slideshow, TabControl, cake;
    ...
    invoke: function(action, params) {
      if (action != null) {
        if (action === "create") {
          ...
          return cake.combo.getValue.call(this);
        } else if (action === "setValue") {
          return cake.combo.setValue.call(this, params);
        } else {
    ...
    invoke: function(action, params) {
      if (action != null) {
        if (action === "create") {
          ...
          return cake.tabs.getActiveTab.call(this);
        } else {
