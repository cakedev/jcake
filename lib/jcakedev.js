(function() {
  var Combo, Slideshow, TabControl, jcakedev;
  ...
  jcakedev = {
    _init: function($) {
      $.fn.jcakedev = function(plugin, action, params) {
        if (this.length) {
          if (plugin != null) {
            if (jcakedev[plugin] != null) {
              return jcakedev[plugin].invoke.call(this, action, params);
            } else {
  ...
  jcakedev.slideshow = {
    ...
    setNavigationControls: function(slideshow, width, height) {
      ...
      $arrowleft.on("click", function() {
        ...
        return jcakedev.slideshow.movePrevious.call(slideshow.element);
      });
      $arrowright.on("click", function() {
        slideshow.autoNavigate = false;
        return jcakedev.slideshow.moveNext.call(slideshow.element);
      });
      return true;
    },
    setAutoNavigation: function(slideshow) {
      return jcakedev.slideshow.autoNavigate(slideshow);
    },
    autoNavigate: function(slideshow) {
      setTimeout(function() {
        if (slideshow.autoNavigate) {
          return jcakedev.slideshow.moveNext.call(slideshow.element, function() {
            return jcakedev.slideshow.autoNavigate(slideshow);
          });
        }
      }, slideshow.delay);
    ...
    moveNext: function(callback, animationSpeed) {
      var slideshow, speed;
      slideshow = jcakedev.slideshow.getCurrentElement.call(this);
      if (slideshow != null) {
        ...
        if (slideshow.slides.length > 1) {
          ...
          if (slideshow.currentIndex === slideshow.slides.length - 1) {
            ...
            jcakedev.slideshow.changeSlide(slideshow.slides.eq(slideshow.currentIndex), slideshow.slides.eq(slideshow.currentIndex + 1), speed, "f", function() {
      ...
      if (slideshow != null) {
        ...
        if (slideshow.slides.length > 1) {
          ...
          if (slideshow.currentIndex === 0) {
            ...
            slideshow.animating = true;
            jcakedev.slideshow.changeSlide(slideshow.slides.eq(slideshow.currentIndex), slideshow.slides.eq(slideshow.currentIndex - 1), speed, "b", function() {
              slideshow.animating = false;
              slideshow.currentIndex--;
              if (typeof callback === "function") return callback();
            });
    ...
    moveToFirst: function(slideshow, slideAnimationSpeed, callback) {
      if (slideshow.currentIndex > 0) {
        jcakedev.slideshow.movePrevious.call(slideshow.element, function() {
          return jcakedev.slideshow.moveToFirst(slideshow, slideAnimationSpeed, callback);
        }, slideAnimationSpeed);
      } else {
    ...
    moveToLast: function(slideshow, slideAnimationSpeed, callback) {
      if (slideshow.currentIndex < slideshow.slides.length - 1) {
        jcakedev.slideshow.moveNext.call(slideshow.element, function() {
          return jcakedev.slideshow.moveToLast(slideshow, slideAnimationSpeed, callback);
        }, slideAnimationSpeed);
      } else {
        if (typeof callback === "function") callback();
      }
    ...
    getCurrentElement: function() {
      ...
      _ref = jcakedev.slideshow.slideshows;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        slideshow = _ref[_i];
