...
(function() {
  ...
  jcakedev = {
    ...
    unlockContent: function(callback) {
      var $locker, doFinalActions;
      $locker = $("#cakedev-screenLocker");
      doFinalActions = function() {
        $locker.remove();
        if (typeof callback === "function") {
          return callback();
        }
      ...
      if ($locker.length) {
        return $locker.fadeOut("fast", doFinalActions);
      } else {
        return doFinalActions();
      }
    },
    init: function($) {
      var plugin, _results;
  ...
  jcakedev.plugins.panel = {
    ...
    show: function($obj) {
      ...
      return $obj.each(function() {
        ...
        if (panel != null) {
          if (panel.modal) {
            return me.pluginManager.lockContent(function() {
              return panel.show();
            });
          } else {
            return panel.show();
    ...
    hide: function($obj) {
      ...
      return $obj.each(function() {
        ...
        if (panel != null) {
          panel.hide();
          if (panel.modal) {
            return me.pluginManager.unlockContent();
          }
        }
      });
    }
  ...
  Panel = (function() {
    ...
    function Panel(el, title, modal, draggable, closable, width, height) {
      ...
      this.panel.css("margin-left", "-" + (Math.round(this.panel.width() / 2)) + "px");
    ...
    Panel.prototype.setTitle = function() {
      ...
      return this.header.append("<h1>" + this.title + "</h1>");
    };

    Panel.prototype.onMousemove = function(event) {
      if (this.draggingOffset != null) {
        if (!this.panel.hasClass("-cakedev-draggable")) {
          this.panel.addClass("-cakedev-draggable");
        }
    ...
    Panel.prototype.setDraggable = function(allowDrag) {
      ...
      if (allowDrag) {
        ...
        return this.panel.on("mousedown", function(event) {
          me.draggingOffset = {
        ...
        this.panel.removeClass("-cakedev-draggable");
        return this.panel.off("mousedown");
      }
    };
  ...
  $(document).on("mouseup", function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (cmp instanceof Panel) {
        ...
        _results.push(cmp.panel.removeClass("-cakedev-draggable"));
      } else {
        _results.push(void 0);
      }
    }
