...
(function() {
  var Combo, Slideshow, TabControl, Table, Tooltip, jcakedev,
    __slice = [].slice;
  ...
  jcakedev.plugins.tooltip = {
    ...
    create: function($obj, params) {
      var animate, direction, hMargin, me, text, vMargin;
      me = this;
      ...
      return $obj.each(function() {
        var tooltip;
        tooltip = new Tooltip($(this), text, direction, hMargin, vMargin, animate);
  ...
  Tooltip = (function() {
    ...
    function Tooltip(el, text, direction, hMargin, vMargin, animate) {
      var me;
      this.el = el;
      this.text = text;
      this.direction = direction;
    ...
    Tooltip.prototype.createTooltip = function() {
      ...
      return this.setDirection(this.direction);
    };
