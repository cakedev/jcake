...
(function() {
  ...
  Combo = (function() {
    ...
    function Combo(id, element, options, delegate) {
      ...
      this.element.append("<table>" + "<tr>" + "<td class='-cakedev-combo-optionText'></td>" + "<td class='-cakedev-combo-arrow'><div class='-cakedev-arrow -cakedev-arrow-down-black'></div></td>" + "</tr>" + "</table>");
      this.setOptions();
      this.setCurrentOption();
      me = this;
      this.element.on("mouseenter", function() {
        return me.showList(true);
      });
      this.element.on("mouseleave", function() {
        return me.hideList(true);
      });
    }
