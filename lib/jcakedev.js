...
(function() {
  ...
  Panel = (function() {
    ...
    function Panel(el, title, modal, draggable, closable, width, height) {
      ...
      this.width = width;
      this.height = height;
      this.el.addClass("-cakedev-panel");
    ...
    Panel.prototype.onMousemove = function(event) {
      if (this.draggingOffset != null) {
        if (!this.el.hasClass("-cakedev-draggable")) {
          this.el.addClass("-cakedev-draggable");
        }
    ...
    Panel.prototype.setDraggable = function(allowDrag) {
      ...
      if (allowDrag) {
        ...
        return this.el.on("mousedown", function(event) {
          me.draggingOffset = {
        ...
        this.el.removeClass("-cakedev-draggable");
        return this.el.off("mousedown");
      }
    };
  ...
  $(document).on("mouseup", function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (cmp instanceof Panel) {
        ...
        _results.push(cmp.el.removeClass("-cakedev-draggable"));
      } else {
        _results.push(void 0);
      }
    }
